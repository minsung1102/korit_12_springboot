...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(withDefaults())
                .sessionManagement(sessionManagenemt
                        -> sessionManagenemt.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                .authorizeHttpRequests(authrizeHttpRequests
                        -> authrizeHttpRequests.requestMatchers(HttpMethod.POST, "/login")
